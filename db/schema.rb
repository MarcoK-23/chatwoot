...
ActiveRecord::Schema[7.1].define(version: 2025_05_23_031839) do
  ...
  create_table "navigator_assistant_responses", force: :cascade do |t|
    ...
    t.index ["account_id"], name: "index_navigator_assistant_responses_on_account_id"
    t.index ["assistant_id"], name: "index_navigator_assistant_responses_on_assistant_id"
    ...
    t.index ["status"], name: "index_navigator_assistant_responses_on_status"
  end

  create_table "navigator_assistants", force: :cascade do |t|
    t.string "name", null: false
    t.bigint "account_id", null: false
    t.string "description"
    t.datetime "created_at", null: false
    ...
    t.index ["account_id"], name: "index_navigator_assistants_on_account_id"
  end

  create_table "navigator_documents", force: :cascade do |t|
    t.string "name"
    ...
    t.datetime "updated_at", null: false
    t.integer "status", default: 0, null: false
    t.index ["account_id"], name: "index_navigator_documents_on_account_id"
    t.index ["assistant_id", "external_link"], name: "index_navigator_documents_on_assistant_id_and_external_link", unique: true
    t.index ["assistant_id"], name: "index_navigator_documents_on_assistant_id"
    t.index ["status"], name: "index_navigator_documents_on_status"
  end

  create_table "navigator_inboxes", force: :cascade do |t|
    t.bigint "navigator_assistant_id", null: false
    t.bigint "inbox_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["navigator_assistant_id", "inbox_id"], name: "index_navigator_inboxes_on_navigator_assistant_id_and_inbox_id", unique: true
    t.index ["navigator_assistant_id"], name: "index_navigator_inboxes_on_navigator_assistant_id"
    t.index ["inbox_id"], name: "index_navigator_inboxes_on_inbox_id"
  end
