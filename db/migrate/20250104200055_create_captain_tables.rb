class CreateNavigatorTables < ActiveRecord::Migration[7.0]
  ...
  def create_assistants
    ...
    add_index :navigator_assistants, [:account_id, :name], unique: true
  end
  ...
  def create_assistant_responses
    ...
    add_index :navigator_assistant_responses, :document_id
    add_index :navigator_assistant_responses, :embedding, using: :ivfflat, name: 'vector_idx_knowledge_entries_embedding', opclass: :vector_l2_ops
  end
