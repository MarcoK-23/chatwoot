...
RSpec.describe Message do
  ...
  it 'updates first reply if the message is human and even if there are messages from navigator' do
    navigator_assistant = create(:navigator_assistant, account: conversation.account)
    ...
    create(:message, message_type: :outgoing, conversation: conversation, sender: navigator_assistant)
