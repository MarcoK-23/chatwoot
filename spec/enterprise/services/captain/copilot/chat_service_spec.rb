...
RSpec.describe Navigator::Copilot::ChatService do
  ...
  let!(:copilot_message) do
    create(
      :navigator_copilot_message, account: account, copilot_thread: copilot_thread
    )
  end
  ...
  before do
    create(:installation_config, name: 'NAVIGATOR_OPEN_AI_API_KEY', value: 'test-key')
