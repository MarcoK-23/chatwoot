...
RSpec.describe 'Api::V1::Accounts::Navigator::BulkActions', type: :request do
  ...
  describe 'POST /api/v1/accounts/:account_id/navigator/bulk_actions' do
    context 'when approving responses' do
      ...
      it 'approves the responses and returns the updated records' do
        post "/api/v1/accounts/#{account.id}/navigator/bulk_actions",
             params: valid_params,
