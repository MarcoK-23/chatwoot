class Api::V1::Accounts::Navigator::BulkActionsController < Api::V1::Accounts::BaseController
  ...
  def handle_assistant_responses
    responses = Current.account.navigator_assistant_responses.where(id: params[:ids])
