class Navigator::Llm::ConversationFaqService < Llm::BaseOpenAiService
  ...
  def find_and_separate_duplicates(faqs)
    ...
    faqs.each do |faq|
      ...
      embedding = Navigator::Llm::EmbeddingService.new.get_embedding(combined_text)
  ...
  def chat_parameters
    ...
    prompt = Navigator::Llm::SystemPromptsService.conversation_faq_generator(account_language)
