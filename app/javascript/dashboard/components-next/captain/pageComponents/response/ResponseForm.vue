...
const formState = {
  uiFlags: useMapGetter('navigatorResponses/getUIFlags'),
  assistants: useMapGetter('navigatorAssistants/getRecords'),
};
...
const getErrorMessage = (field, errorKey) => {
  return v$.value[field].$error
    ? t(`NAVIGATOR.RESPONSES.FORM.${errorKey}.ERROR`)
    : '';
};
...
<template>
  <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
    <Input
      ...
      :label="t('NAVIGATOR.RESPONSES.FORM.QUESTION.LABEL')"
      :placeholder="t('NAVIGATOR.RESPONSES.FORM.QUESTION.PLACEHOLDER')"
    ...
    <Editor
      ...
      :label="t('NAVIGATOR.RESPONSES.FORM.ANSWER.LABEL')"
      :placeholder="t('NAVIGATOR.RESPONSES.FORM.ANSWER.PLACEHOLDER')"
    ...
    <div class="flex flex-col gap-1">
      <label for="assistant" class="mb-0.5 text-sm font-medium text-n-slate-12">
        {{ t('NAVIGATOR.RESPONSES.FORM.ASSISTANT.LABEL') }}
      </label>
      <ComboBox
        id="assistant"
        ...
        :placeholder="t('NAVIGATOR.RESPONSES.FORM.ASSISTANT.PLACEHOLDER')"
