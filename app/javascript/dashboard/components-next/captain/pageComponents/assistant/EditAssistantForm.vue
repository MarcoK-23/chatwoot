...
<template>
  <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
    ...
    <Accordion
      :title="t('NAVIGATOR.ASSISTANTS.FORM.SECTIONS.BASIC_INFO')"
      is-open
    >
      <div class="flex flex-col gap-4 pt-4">
        ...
        <div class="flex justify-end">
          ...
          >
            {{ t('NAVIGATOR.ASSISTANTS.FORM.UPDATE') }}
          </Button>
        </div>
      </div>
    </Accordion>
    ...
    <Accordion :title="t('NAVIGATOR.ASSISTANTS.FORM.SECTIONS.INSTRUCTIONS')">
      <div class="flex flex-col gap-4">
        <Editor
          v-model="state.instructions"
          :placeholder="t('NAVIGATOR.ASSISTANTS.FORM.INSTRUCTIONS.PLACEHOLDER')"
        ...
        <div class="flex flex-col gap-2 mt-4">
          <label class="text-sm font-medium text-n-slate-12">
            {{ t('NAVIGATOR.ASSISTANTS.FORM.TEMPERATURE.LABEL') }}
          </label>
          ...
          <p class="text-sm text-n-slate-11 italic">
            {{ t('NAVIGATOR.ASSISTANTS.FORM.TEMPERATURE.DESCRIPTION') }}
          </p>
        </div>
        <div class="flex justify-end">
          <Button
            size="small"
            :loading="isLoading"
            :label="t('NAVIGATOR.ASSISTANTS.FORM.UPDATE')"
    ...
    <Accordion :title="t('NAVIGATOR.ASSISTANTS.FORM.SECTIONS.SYSTEM_MESSAGES')">
      <div class="flex flex-col gap-4 pt-4">
        <Editor
          v-model="state.handoffMessage"
          :label="t('NAVIGATOR.ASSISTANTS.FORM.HANDOFF_MESSAGE.LABEL')"
          :placeholder="
            t('NAVIGATOR.ASSISTANTS.FORM.HANDOFF_MESSAGE.PLACEHOLDER')
          "
        ...
        <Editor
          ...
          :label="t('NAVIGATOR.ASSISTANTS.FORM.RESOLUTION_MESSAGE.LABEL')"
          :placeholder="
            t('NAVIGATOR.ASSISTANTS.FORM.RESOLUTION_MESSAGE.PLACEHOLDER')
          "
    ...
    <!-- Features Section -->
    <Accordion :title="t('NAVIGATOR.ASSISTANTS.FORM.SECTIONS.FEATURES')">
      <div class="flex flex-col gap-4 pt-4">
