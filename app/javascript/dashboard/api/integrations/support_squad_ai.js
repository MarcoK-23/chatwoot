...
/**
 * Represents the data object for a SupportSquadAI hook.
...
/**
 * A client for the SupportSquadAI API.
 * @extends ApiClient
 */
class SupportSquadAIAPI extends ApiClient {
  /**
   * Creates a new SupportSquadAIAPI instance.
   */
  constructor() {
  ...
  /**
   * Processes an event using the SupportSquadAI API.
...
export default new SupportSquadAIAPI(); 